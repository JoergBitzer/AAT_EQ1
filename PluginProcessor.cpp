...
//==============================================================================
PeakEQAudioProcessor::PeakEQAudioProcessor()
                       ...
                       )
{
    ...
    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("PeakEQVTS"),
...
//==============================================================================
const juce::String PeakEQAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool PeakEQAudioProcessor::acceptsMidi() const
{
...
bool PeakEQAudioProcessor::producesMidi() const
{
...
bool PeakEQAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double PeakEQAudioProcessor::getTailLengthSeconds() const
{

    return 0.0;
}

int PeakEQAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int PeakEQAudioProcessor::getCurrentProgram()
{
    return 0;
}

void PeakEQAudioProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String PeakEQAudioProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void PeakEQAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
...
void PeakEQAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool PeakEQAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void PeakEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool PeakEQAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* PeakEQAudioProcessor::createEditor()
{
    return new PeakEQAudioProcessorEditor (*this);
}

//==============================================================================
void PeakEQAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void PeakEQAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new PeakEQAudioProcessor();
}
