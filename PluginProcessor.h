...
//==============================================================================
class PeakEQAudioProcessor  : public juce::AudioProcessor
{
public:
    friend class PeakEQAudioProcessorEditor;
    //==============================================================================
    PeakEQAudioProcessor();
    ~PeakEQAudioProcessor() override;
...
private:
    ...
    PeakEQAudio m_algo;
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PeakEQAudioProcessor)
};
